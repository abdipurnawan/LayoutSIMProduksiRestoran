              ...
              <tbody>
                <tr class="text-center align-middle my-auto">
                  ...
                  <td class="text-center align-middle d-none d-md-table-cell">
                    <a style="margin-right:7px" class="btn btn-info btn-sm" href="{{ route('Detail Menu Makanan') }}" ><i class="fas fa-eye" ></i></a><a class="btn btn-danger btn-sm" onclick="deleteMenu()" href="#"><i class="fas fa-trash"></i></a>
                  </td>
                </tr>
                <tr class="text-center align-middle my-auto">
