          ...
          <div class="card-header">
            <div class="row">
              <div class="col-6 my-auto">
                <h3 class="card-title my-auto">Tambah Menu Makanan</h3>
              </div>
            </div>
          </div>
          <div class="card-body">
            <form id="form-product" method="post" action="/store-menu-makanan" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group mt-4">
                    ...
                    <button type="submit" class="btn btn-success" href="/"><i class="fa fa-save"></i> Tambah</button>
                </div>
            </form>
                </form>
            </div>
